      ...
      <div className="max-w-7xl w-full mx-auto flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full items-stretch">
          ...
          <div className="relative w-full bg-dark-800 rounded-[2rem] border-[3px] border-gold-500/50 p-8 sm:p-10 shadow-2xl overflow-hidden flex flex-col h-full hover:border-gold-500 transition-colors duration-300">
            ...
            <div className="relative z-10 flex flex-col h-full">
              <div className="flex flex-col items-center text-center relative z-10">
                ...
                <p className="text-gold-500 font-medium text-sm mb-2 uppercase tracking-wider">
                  For Your Special Day
                </p>
                <p className="text-gray-400 text-sm leading-relaxed mb-8">
                  Professional coverage for your wedding celebrations,
                  specializing in traditional and modern Indian ceremonies with
                  elegant, timeless captures.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-10">
                {weddingTiers.map((tier) => (
                  <div
                    key={tier.name}
                    className="border-[3px] border-gold-500/40 rounded-xl p-4 text-center bg-primary flex flex-col justify-center min-h-[100px] hover:border-gold-500 transition-colors duration-300"
                  >
              ...
              <div className="mt-auto pt-4">
                <button
                  ...
                  className="w-full bg-gradient-to-r from-gold-500 to-gold-600 text-white font-bold py-4 rounded-xl flex items-center justify-center hover:opacity-90 transition-opacity shadow-lg shadow-gold-500/20"
                >
          ...
          <div className="relative w-full bg-dark-800 rounded-[2rem] border-[3px] border-gold-500/50 p-8 sm:p-10 shadow-2xl overflow-hidden flex flex-col h-full hover:border-gold-500 transition-colors duration-300">
            ...
            <div className="mt-8 relative z-10 flex-1 mb-8">
              <p className="text-gold-400 font-medium mb-6 text-lg text-center sm:text-left">
                What included
              </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16 w-full max-w-6xl">
          {bottomFeatures.map((feat, idx) => (
            <div
              key={idx}
              className="bg-primary border-[3px] border-gold-500/40 rounded-2xl p-6 flex flex-row items-start text-left hover:border-gold-500 transition-colors duration-300 group"
            >
